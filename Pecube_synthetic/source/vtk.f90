...
real,dimension(:),allocatable::xs,ys,zs,ex,a1,a2,a3,a4,a5,a6,a7,a8,ftlm
...
nrec=1
2 read (77,rec=(nrec-1)*(4+13*nsurf+npe*nelemsurf)+1) nnx
...
open (77,file=run//'/Ages.out',status='old',access='direct',recl=4*(4+13*nsurf+npe*nelemsurf))
...
read (77,rec=irec+1) nsurf,nelemsurf,npe,tim,xs,ys,zs,ex,a1,a2,a3,a4,a5,a6,a7,a8,ftlm,iconsurf
