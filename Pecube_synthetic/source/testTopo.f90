subroutine testTopo (nx,ny,nz,xl,yl,zl,timesteps,nstep,xlon1,xlat1,xlon2,xlat2,fltflag)
...
allocate (timek(nstep+1),topomag(nstep+1),topooffset(nstep+1))

  do istep=1,nstep+1
  read (77,*) timek(istep),topomag(istep),topooffset(istep)
  enddo
