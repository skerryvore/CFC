...
cifdef MPI
d       call MPI_Init(ierr )      
d       call MPI_Comm_size( MPI_COMM_WORLD, nproc, ierr ) 
d       call MPI_Comm_rank( MPI_COMM_WORLD, iproc, ierr ) 
...
cifdef MPI
d          CALL MPI_ALLREDUCE
d    &          (misfit(ntot+1), sum, ns, 
d    &           MPI_REAL, MPI_SUM, MPI_COMM_WORLD, ierr)
cendif
...
c						file in NA_sobol
d          call MPI_BARRIER(MPI_COMM_WORLD)
cendif
...
d        include "mpif.h"
d       integer	ierr
d       call mpi_abort(MPI_COMM_WORLD, ierr)
cendif
	stop
	end
